...
# draw_time_section(ax, section_positions[0], start_3m, end_3m, colors, labels, "Cấp 3M")
...
# draw_time_section(ax, section_positions[1], start_1m, end_1m, colors, labels, "Cấp 1M")
...
# draw_time_section(ax, section_positions[4], start_week, end_week, colors, labels, "Cấp W")
...
# draw_time_section(ax, section_positions[5], start_quarter_week, end_quarter_week, colors, labels, "1/4W hiện tại")
...
# draw_time_section(ax, section_positions[6], start_sixteenth_week, end_sixteenth_week, colors, labels, "1/4 của 1/4W hiện tại")
