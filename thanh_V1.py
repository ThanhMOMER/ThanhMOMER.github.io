...
# 1/4W (1/4 Week)
start_quarter_week = start_week
end_quarter_week = start_quarter_week + timedelta(hours=42)  # 7*24/4 = 42 giờ

# 1/16W (1/4 của 1/4W)
start_sixteenth_week = start_week
end_sixteenth_week = start_sixteenth_week + timedelta(hours=10.5)  # 7*24/16 = 10.5 giờ

# Vẽ các cấp theo thứ tự tăng dần từ lớn đến nhỏ (Cấp 3M trên cùng)
